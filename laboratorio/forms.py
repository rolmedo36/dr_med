...
class CreateNewClientes(forms.Form):
    ...
    telefono2 = forms.CharField(label='Teléfono 2:',
    ...
    calle = forms.CharField(label='Dirección:',
                            widget=forms.TextInput(attrs={'size': '40', 'placeholder': 'Calle'}))
    numero_ext = forms.CharField(label='Núm.Exterior:',
                                 widget=forms.TextInput(attrs={'size': '12', 'placeholder': 'Núm.Exterior'}))
    numero_int = forms.CharField(label='Núm.Interior:',
